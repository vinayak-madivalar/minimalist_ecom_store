...
const HeroSection = () => {
  ...
  const slides = [
    { id: 1, imgUrl: "1.png", alt: "slide 1" },
    { id: 2, imgUrl: "3.png", alt: "slide 2" },
    { id: 3, imgUrl: "2.png", alt: "slide 3" },
    { id: 4, imgUrl: "4.png", alt: "slide 4" },
    ...
    <div>
      ...
      <div className="mb-8 bg-gray-100 py-8">
        ...
        <div className="flex items-center justify-center px-2 gap-4 overflow-x-auto">
          <button
            id="new-arrival"
            className="lg:px-6 px-2 py-2 border uppercase rounded text-sm font-semibold border-black focus:bg-black focus:text-white"
            onClick={() => handleCategoryChange("mens-shoes")}
          >
            New Arrivals
          </button>
          <button
            className="lg:px-6 px-2 py-2 border uppercase text-sm rounded font-semibold border-black focus:bg-black focus:text-white"
