    ...
    <div>
      ...
      <div className="flex flex-wrap lg:flex-nowrap gap-4 lg:gap-12 my-8">
        ...
        <div className="w-full px-4 lg:w-1/2">
          ...
          <p className="text-2xl font-semibold mb-2 flex items-center gap-1">
            <BsCurrencyDollar size={23} /> {product.price}
          </p>
          ...
          <div className="flex gap-2 mb-8">
            <button
              ...
              className="px-8 lg:px-16 py-3 border-blue-600 text-blue-600 font-semibold border rounded"
            >
              Add to Cart
            </button>
            <button className="px-8 lg:px-16 py-3 font-semibold rounded bg-blue-600 text-white ">
              Buy Now
            </button>
          </div>
          <div className="mb-8">
