...
const Aboutus = () => {
  return (
    <div>
      <Navbar />
      <div className="flex flex-wrap lg:flex-nowrap justify-center items-center gap-8 mx-4 lg:mx-20 my-8">
      ...
      <div className="flex flex-wrap lg:flex-nowrap gap-8 mx-4 lg:mx-20">
        <div className="w-full md:w-1/3 border border-black px-6 py-4">
          <img src="delivery.png" width="60" alt="delivery truck" />
          <h5 className="text-xl font-semibold my-2">Free Shipping</h5>
          <p className="lg:w-72 text-gray-500 font-sans">
            Lorem Ipsum is simply dummy text of the printing and typesetting
